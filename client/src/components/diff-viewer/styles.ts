...
export const s = {
  ...
  summaryIcon: { flexShrink: 0, marginTop: 2 } satisfies CSSProperties,
  summaryLabel: { fontWeight: 600, flexShrink: 0 } satisfies CSSProperties,
  summaryText: { overflowWrap: "anywhere", whiteSpace: "pre-wrap" } satisfies CSSProperties,
  hunk: {
    fontSize: 12,
    lineHeight: "20px",
    color: "var(--accent-text)",
