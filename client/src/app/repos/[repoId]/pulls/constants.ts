...
/** Grid template for both the header row and PR rows. Tracks map 1:1 to
 *  COLUMN_KEYS (length-aligned): pullRequest, author, size, score, findings,
 *  status, cost, updated. */
export const GRID = "1fr 132px 92px 60px 132px 118px 84px 78px";
